...
class RatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rating" do
    assert_difference('Rating.count') do
      post ratings_url, params: { rating: { book_id: @rating.book_id, value: @rating.value } }
    end
  ...
  test "should update rating" do
    patch rating_url(@rating), params: { rating: { book_id: @rating.book_id, value: @rating.value } }
